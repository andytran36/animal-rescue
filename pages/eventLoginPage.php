...
<head>
    ...
    <style type="text/css">
		...
		body{
			background-image: url("../imgs/eventLoginPic.jpg");
...
-->
	<div class="row pageCustom">
			<div class="col-xs-12">
				<div id="content">
					<form action="../includes/validateEventLogin.php" method="POST">
				  		<div class="form-group">
				   			 <label>The Event's unique ID: </label>
				    		<input type="text" name="eventID" class="form-control" placeholder="Enter Event ID" required><br>
				  		</div>
